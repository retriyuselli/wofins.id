...
<div class="wf-profile-sidebar relative lg:sticky lg:top-24">
    <div class="wf-profile-sidebar-head">
        <div class="flex items-center gap-3">
            <div class="w-10 h-10 rounded-full bg-white/15 overflow-hidden flex items-center justify-center ring-2 ring-[var(--wf-gold)]/40">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profileUser?->avatar_url): ?>
                    <img class="w-10 h-10 object-cover"
                        src="<?php echo e(Storage::url($profileUser->avatar_url)); ?>"
                        alt="Profile <?php echo e($profileUser->name); ?>"
                        onerror="this.src='https://ui-avatars.com/api/?name=<?php echo e(urlencode($profileUser->name)); ?>&color=e8d48b&background=<?php echo e($avatarBg); ?>&size=128&font-size=0.4'">
                <?php else: ?>
                    <img class="w-10 h-10 object-cover"
                        src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($profileUser->name)); ?>&color=e8d48b&background=<?php echo e($avatarBg); ?>&size=128&font-size=0.4"
                        alt="Profile <?php echo e($profileUser->name); ?>">
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <div class="min-w-0">
                <div class="text-sm font-semibold text-white truncate"><?php echo e($profileUser->name); ?></div>
                <div class="text-xs text-white/65 truncate"><?php echo e($profileUser->email); ?></div>
                <div class="mt-1.5 text-[10px] font-semibold tracking-wide uppercase text-[var(--wf-gold-soft)] truncate">
                    <?php echo e($subscriptionPlanLabel ?? \App\Support\CompanySubscription::planLabel()); ?>
    ...
    <nav class="p-3 space-y-1">
        <?php
            ...
            $ordersActive = request()->routeIs('pesanan-saya*');
        ?>

        <a href="<?php echo e(route('profile')); ?>"
            class="wf-profile-nav-link <?php echo e($overviewActive ? 'is-active' : ''); ?>">
        ...
        <a href="<?php echo e(route('pesanan-saya')); ?>"
            class="wf-profile-nav-link <?php echo e($ordersActive ? 'is-active' : ''); ?>">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="<?php echo e(route('profile.compensation')); ?>"
            class="wf-profile-nav-link <?php echo e($compensationActive ? 'is-active' : ''); ?>">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isSuperAdmin): ?>
            <a href="<?php echo e(route('profile.financial-report')); ?>"
                class="wf-profile-nav-link <?php echo e($financialReportActive ? 'is-active' : ''); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="<?php echo e(route('profile.edit')); ?>"
            class="wf-profile-nav-link <?php echo e($editActive ? 'is-active' : ''); ?>">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canAccessAdmin): ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canSeeAdminTools): ?>
        <div class="px-3 pb-3">
            <div class="my-3 border-t border-[var(--wf-line)]"></div>
            ...
            <div class="space-y-1">
                <a href="<?php echo e(route('profile.admin-tools')); ?>" class="wf-profile-nav-link <?php echo e($isAdminTools ? 'is-active' : ''); ?>">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16" /></svg>
                    <span>Ringkasan Admin</span>
                </a>
                <a href="<?php echo e(route('profile.admin-tools.users')); ?>" class="wf-profile-nav-link <?php echo e($isAdminUsers ? 'is-active' : ''); ?>">
                ...
                <a href="<?php echo e(route('profile.admin-tools.roles')); ?>" class="wf-profile-nav-link <?php echo e($isAdminRoles ? 'is-active' : ''); ?>">
                ...
                <a href="<?php echo e(route('profile.admin-tools.company')); ?>" class="wf-profile-nav-link <?php echo e($isAdminCompany ? 'is-active' : ''); ?>">
                ...
                <a href="<?php echo e(route('profile.admin-tools.sops')); ?>" class="wf-profile-nav-link <?php echo e($isAdminSops ? 'is-active' : ''); ?>">
                ...
                <a href="<?php echo e(route('profile.admin-tools.projects')); ?>" class="wf-profile-nav-link <?php echo e($isAdminProjects ? 'is-active' : ''); ?>">
                ...
                <a href="<?php echo e(route('profile.admin-tools.nota-dinas')); ?>" class="wf-profile-nav-link <?php echo e($isAdminNotaDinas ? 'is-active' : ''); ?>">
                ...
                <a href="<?php echo e(route('profile.admin-tools.bank-statements')); ?>" class="wf-profile-nav-link <?php echo e($isAdminBankStatements ? 'is-active' : ''); ?>">
                ...
                <a href="<?php echo e(route('profile.admin-tools.documentations')); ?>" class="wf-profile-nav-link <?php echo e($isAdminDocumentations ? 'is-active' : ''); ?>">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h10M7 11h10M7 15h6M5 3h10l4 4v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2z" /></svg>
                    <span>Dokumentasi</span>
                </a>
                <a href="<?php echo e(route('profile.admin-tools.document-categories')); ?>" class="wf-profile-nav-link <?php echo e($isAdminDocumentCategories ? 'is-active' : ''); ?>">
                ...
                <a href="<?php echo e(route('profile.admin-tools.help-center')); ?>" class="wf-profile-nav-link <?php echo e($isAdminHelpCenter ? 'is-active' : ''); ?>">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/application/wofins/resources/views/profile/partials/sidebar.blade.php ENDPATH**/ ?>