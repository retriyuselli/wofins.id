...
<body>
            ...
            <tr>
                <td style="width: 65%;">
                    ...
                    <div class="company-info">
                        Alamat : <?php echo e($companyAddress); ?><br>
                        No. Tlp : <?php echo e($companyPhone); ?><br>
                ...
                <td style="width: 35%; text-align: right; vertical-align: top;">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logoSrc): ?>
                        <img src="<?php echo e($logoSrc); ?>" alt="Logo Perusahaan" class="logo-img" style="max-height: 56px; max-width: 140px; width: auto; height: auto;">
                    <?php else: ?>
            ...
            <tr>
                <td style="text-align: right; vertical-align: bottom; padding-right: 0px; font-size: 9px;">
                    ...
                    <span>
                        ...
                        <?php echo e($printedAt->translatedFormat('d F Y')); ?> pukul <?php echo e($printedAt->translatedFormat('H:i')); ?> |
    ...
    <div class="subtitle">Nomor : <?php echo e($nomorSurat); ?></div>
    ...
    <table class="content-table">
        <tr>
            ...
            <td><?php echo e($companyOwnerName); ?></td>
        </tr>
        <tr>
            <td></td>
            <td class="label">Jabatan</td>
            <td class="separator">:</td>
            <td><?php echo e($companyOwnerPosition); ?></td>
        </tr>
        <tr>
            <td></td>
            <td class="label">No. Telp</td>
            <td class="separator">:</td>
            <td><?php echo e($companyPhone); ?></td>
        </tr>
    </table>
    <div class="text-justify indent" style="margin-bottom: 10px;">
        Bertindak untuk dan atas nama <?php echo e($companyName); ?> beralamat di <?php echo e($companyAddress); ?>, selanjutnya disebut
        PIHAK PERTAMA.
    </div>
    ...
    <table class="content-table">
        <tr>
            ...
            <td class="label">Nama</td>
            <td class="separator">:</td>
            <td><?php echo e($record->name_ttd ?? '{Nama Pihak Kedua}'); ?>
        ...
        <tr>
            ...
            <td class="label">No. Telp</td>
            <td class="separator">:</td>
            <td>+62<?php echo e($prospect->phone ?? '-'); ?></td>
        </tr>
        <tr>
            <td></td>
            <td class="label">Alamat</td>
            <td class="separator">:</td>
            <td><?php echo e($prospect->address ?? '{Alamat Sesuai KTP}'); ?></td>
        </tr>
    </table>
    ...
    <div class="text-justify" style="margin-bottom: 15px;">
        Sehubungan dengan akan diadakannya Pernikahan <b><?php echo e($prospect->name_cpw ?? '...'); ?> &
            <?php echo e($prospect->name_cpp ?? '...'); ?></b> di <b><?php echo e($prospect->venue ?? '...'); ?></b>, berikut adalah rincian
        dan
    ...
    <table class="content-table">
        <tr>
            ...
            <td class="separator">:</td>
            <td><?php echo e($prospect->name_event ?? '-'); ?></td>
        </tr>
        <tr>
            <td class="label">Paket WO</td>
            <td class="separator">:</td>
            <td>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->product?->name): ?>
                    <?php echo e(\Illuminate\Support\Str::title($record->product->name)); ?>
        ...
        <tr>
            ...
            <td class="separator">:</td>
            <td><?php echo e($prospect->venue ?? '-'); ?></td>
        </tr>
    </table>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($prospect->date_lamaran)): ?>
        <div class="section-title">Lamaran / Pengajian / Siraman</div>
        <table class="content-table">
            <tr>
                <td class="label">Hari / Tanggal</td>
                <td class="separator">:</td>
                <td><?php echo e(\Carbon\Carbon::parse($prospect->date_lamaran)->locale('id')->translatedFormat('l, d F Y')); ?></td>
            </tr>
            <tr>
                <td class="label">Waktu</td>
                <td class="separator">:</td>
                <td>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($prospect->time_lamaran)): ?>
                        Pukul <?php echo e(\Carbon\Carbon::parse($prospect->time_lamaran)->format('H:i')); ?> wib s.d Selesai
                    <?php else: ?>
            ...
            <tr>
                ...
                <td class="separator">:</td>
                <td>
                    <?php echo e($record->product->pax_akad ?? 500); ?> Pax atau
                    <?php echo e(($record->product->pax_akad ?? 500) / 2); ?> Undangan (Asumsi)
                </td>
            </tr>
        </table>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($prospect->date_akad)): ?>
        <div class="section-title">Akad Nikah</div>
        <table class="content-table">
            <tr>
                <td class="label">Hari / Tanggal</td>
                <td class="separator">:</td>
                <td><?php echo e(\Carbon\Carbon::parse($prospect->date_akad)->locale('id')->translatedFormat('l, d F Y')); ?></td>
            </tr>
            <tr>
                <td class="label">Waktu</td>
                <td class="separator">:</td>
                <td>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($prospect->time_akad)): ?>
                        Pukul <?php echo e(\Carbon\Carbon::parse($prospect->time_akad)->format('H:i')); ?> wib s.d Selesai
                    <?php else: ?>
                        Pukul 07:00 / 07:30 wib s.d Selesai
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </td>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($prospect->date_resepsi)): ?>
        <div class="section-title">Resepsi</div>
        <table class="content-table">
            <tr>
                <td class="label">Hari / Tanggal</td>
                <td class="separator">:</td>
                <td><?php echo e(\Carbon\Carbon::parse($prospect->date_resepsi)->locale('id')->translatedFormat('l, d F Y')); ?></td>
            </tr>
            <tr>
                <td class="label">Waktu</td>
                <td class="separator">:</td>
                <td>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($prospect->time_resepsi)): ?>
                        Pukul <?php echo e(\Carbon\Carbon::parse($prospect->time_resepsi)->format('H:i')); ?> wib s.d Selesai
                    <?php else: ?>
            ...
            <tr>
                <td class="label">Jumlah Undangan</td>
                <td class="separator">:</td>
                <td><?php echo e($record->product->pax ?? 500); ?> Pax atau <?php echo e(($record->product->pax ?? 500) / 2); ?> Undangan (Asumsi)</td>
            </tr>
        </table>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <table class="content-table" style="width: 100%;">
        <tr>
            ...
            <td style="width: 60%; padding: 5px 0; text-align: left;">
                <b>&nbsp;<?php echo e(number_format($baseTotalPrice, 0, ',', '.')); ?>,-</b>
            </td>
        </tr>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($productPenambahan > 0): ?>
            <tr>
                <td style="padding: 5px 0;">PENAMBAHAN</td>
                <td style="width: 1%; white-space: nowrap; padding: 5px 0;">: Rp. </td>
                <td style="text-align: left; padding: 5px 0;">
                    &nbsp;<?php echo e(number_format($productPenambahan, 0, ',', '.')); ?>,-</td>
            </tr>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($productPengurangan > 0): ?>
            <tr>
                <td style="padding: 5px 0;">PENGURANGAN</td>
                <td style="width: 1%; white-space: nowrap; padding: 5px 0;">: Rp. </td>
                <td style="text-align: left; padding: 5px 0;">
                    &nbsp;(<?php echo e(number_format($productPengurangan, 0, ',', '.')); ?>,-)</td>
            </tr>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($promo > 0): ?>
            <tr>
                <td style="padding: 5px 0;">PROMO</td>
                <td style="width: 1%; white-space: nowrap; padding: 5px 0;">: Rp. </td>
                <td style="text-align: left; padding: 5px 0;">
                    &nbsp;(<?php echo e(number_format($promo, 0, ',', '.')); ?>,-)</td>
            </tr>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <tr>
            ...
            <td style="padding: 5px 0; text-align: left;">
                <b>&nbsp;<?php echo e(number_format($computedGrandTotal, 0, ',', '.')); ?>,-</b>
            </td>
        </tr>
    </table>
    ...
    <div class="facility-list">
        <ol>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $groupedItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryName => $categoryItems): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <li style="font-weight: normal; font-size: 11px; margin-top: 1px;">
                    <span class="facility-title"><?php echo e(\Illuminate\Support\Str::title($categoryName)); ?></span>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($categoryItems->count() === 1): ?>
                        <?php
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($penambahanItems->isNotEmpty()): ?>
        <div class="section-title">PENAMBAHAN :</div>
        <div class="facility-list">
            <ol>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $penambahanItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <li>
                        <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                            <div style="margin-right: 10px;">
                                <div style="font-weight: normal; overflow: hidden;">
                                    <?php echo e(strtoupper($item->vendor->name ?? 'Penambahan Tanpa Nama')); ?>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!is_null($item->harga_publish) && (float) $item->harga_publish > 0): ?>
                                        <span class="price-right">
                                            Rp <?php echo e(number_format((int) $item->harga_publish, 0, ',', '.')); ?>,-
                                        </span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
    ...
    <!-- Pengurangan -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($penguranganItems->isNotEmpty()): ?>
        <div class="section-title">PENGURANGAN :</div>
        <div class="facility-list">
            <ol>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $penguranganItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <li>
                        <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                            <div style="margin-right: 10px;">
                                <div style="font-weight: normal; overflow: hidden;">
                                    <?php echo e(\Illuminate\Support\Str::ucfirst(\Illuminate\Support\Str::lower($item->description ?? 'Pengurangan Tanpa Nama'))); ?>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!is_null($item->amount)): ?>
                                        <span class="price-right">
                                            Rp <?php echo e(number_format((int) $item->amount, 0, ',', '.')); ?>,-
                                        </span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
    ...
    ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($freePenguranganText !== ''): ?>
        <div class="section-title">FREE</div>
        <div class="facility-list">
            <?php echo $record->product->free_pengurangan; ?>
    ...
    <ol>
        <li>
            ...
            Rp. <?php echo e(number_format($record->payment_dp_amount ?? 0, 0, ',', '.')); ?>,-
        ...
        <li>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($terminCount > 0): ?>
                <ol type="a" style="margin-top: 5px; margin-left: 10px;">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $termins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $termin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php
                        ...
                        ?>
                        <li>
                            Termin <?php echo e($index + 1); ?>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!is_null($nominal)): ?>
                                sebesar Rp. <?php echo e(number_format((float) $nominal, 0, ',', '.')); ?>,-
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!is_null($persen)): ?>
                                yaitu <?php echo e(rtrim(rtrim(number_format((float) $persen, 2, ',', '.'), '0'), ',')); ?>%
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($bulan)): ?>
                                pada Bulan <?php echo e($bulan); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!is_null($tahun)): ?>
                                    <?php echo e($tahun); ?>
        ...
        <li>Pembayaran dapat dilakukan melalui transfer ke rekening:
            <div style="text-align: center; margin-top: 10px; margin-bottom: 10px;">
                Bank <b><?php echo e($companyBankName); ?></b><br>
                No. Rekening: <b><?php echo e($companyBankAccount); ?></b><br>
                A.n: <b><?php echo e($companyBankHolder); ?></b>
            </div>
        </li>
        <li>Bukti transfer dapat di email ke <?php echo e($companyEmail); ?> atau datang langsung ke kantor <?php echo e($companyName); ?>

            dengan
            menunjukkan bukti ke bagian administrasi.</li>
        <li>Pembayaran secara tunai dilakukan langsung ke bagian administrasi di kantor <?php echo e($companyName); ?> dan
            PIHAK KEDUA akan menerima bukti pembayaran atau pelunasan yang telah ditandatangani oleh bagian keuangan
            atau bisa langsung menghubungi saudari <b><?php echo e($financeUser->name ?? 'Finance'); ?> di nomor
                <?php echo e($financeUser->phone_number ?? '-'); ?></b>.</li>
    ...
    <div style="text-align: right; margin-bottom: 10px; margin-top: 20px;">
        <?php echo e($company->city ?? 'Palembang'); ?>,
            ...
            <tr>
                <td style="vertical-align: bottom; height: 120px;">
                    <div style="text-decoration: underline;">
                        <?php echo e($record->name_ttd ?? '....................'); ?>

                    </div>
                    <b><?php echo e($record->title_ttd ?? 'Calon Pengantin'); ?></b>
                </td>
                <td style="vertical-align: bottom; height: 100px;">
                    <div style="text-decoration: underline;">
                        <?php echo e($companyOwnerName); ?>

                    </div>
                    <b><?php echo e($companyOwnerPosition); ?></b>
                </td>
                <td style="vertical-align: bottom; height: 100px;">
                    <div style="text-decoration: underline;">
                        <?php echo e($record->user?->name ?? 'Account Manager'); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/application/wofins/resources/views/pdf/draft_kontrak.blade.php ENDPATH**/ ?>