<?php $__env->startSection('title', 'Dashboard - ' . (($user ?? null)?->name ?? Auth::user()->name)); ?>
...
<div class="wf-page min-h-screen" x-data="{
    ...
    errorOpen: <?php echo e(session('error') ? 'true' : 'false'); ?>,
    ...
    <div class="py-8 lg:py-10 wf-portal-shell">
        ...
        <div class="wf-portal-shell-inner max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-8 relative">
                ...
                <h1 class="text-3xl font-bold text-[var(--wf-navy)]"><?php echo $__env->yieldContent('profile-page-title', 'Dashboard Profil'); ?></h1>
                <p class="text-[var(--wf-muted)] mt-2"><?php echo $__env->yieldContent('profile-page-subtitle', 'Kelola informasi akun dan data HR Anda'); ?></p>
            </div>
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                <aside class="lg:w-64 shrink-0" :class="sidebarOpen ? 'block' : 'hidden lg:block'">
                    <?php echo $__env->make('profile.partials.sidebar', ['profileUser' => $profileUser], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </aside>

                <main class="flex-1 space-y-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($adminToolsReadonly ?? false) && request()->routeIs('profile.admin-tools*')): ?>
                        <?php echo $__env->make('profile.partials.admin-tools-preview-banner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <?php echo $__env->make('profile.partials.account-access-banner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="relative w-full max-w-md rounded-2xl bg-white border border-[var(--wf-line)] shadow-xl overflow-hidden"
            ...
            <div class="px-6 pt-8 pb-2 text-center">
                ...
                <p class="mt-3 text-sm text-[var(--wf-muted)] leading-relaxed">
                    <?php echo e(session('success', 'Profil berhasil diperbarui.')); ?>
    ...
    <div x-show="errorOpen" x-cloak
        ...
        <div class="relative w-full max-w-md rounded-2xl bg-white border border-[var(--wf-line)] shadow-xl overflow-hidden"
            ...
            <div class="px-6 pt-8 pb-2 text-center">
                ...
                <p class="mt-3 text-sm text-[var(--wf-muted)] leading-relaxed">
                    <?php echo e(session('error', 'Terjadi kesalahan. Silakan coba lagi.')); ?>
...
<?php echo $__env->make('profile.sections.scripts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/application/wofins/resources/views/profile/layout.blade.php ENDPATH**/ ?>