...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/payment/paymentmethod.css')); ?>?v=<?php echo e(@filemtime(public_path('assets/payment/paymentmethod.css'))); ?>">
    ...
    <div class="pm-wf space-y-6">
        <header class="pm-hero">
            ...
            <div class="pm-hero__body">
                <div class="pm-hero__meta">
                    ...
                    <p class="pm-hero__company"><?php echo e($companyName); ?></p>
                    <h1 class="pm-hero__title">DETAILS #<?php echo e($order->number ?? $order->id); ?></h1>
                    <p class="pm-hero__sub">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($eventName): ?>
                            ...
                            <span><?php echo e($eventName); ?></span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </p>
                    <div class="pm-hero__badges">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->is_paid): ?>
                            <span class="pm-badge pm-badge--gold">Paid</span>
                        <?php else: ?>
                            <span class="pm-badge pm-badge--cream">Unpaid</span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <span class="pm-badge pm-badge--outline"><?php echo e($companyName); ?></span>
                    </div>
                </div>
                ...
                <div class="pm-hero__balance">
                    ...
                    <p class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                        ...
                        Rp <?php echo e(number_format($balanceDue, 0, ',', '.')); ?>

                    </p>
                    <p class="pm-hero__balance-delta is-flat">
                        Dibayar Rp <?php echo e(number_format($totalPaid, 0, ',', '.')); ?>

                        dari Rp <?php echo e(number_format($grandTotal, 0, ',', '.')); ?>
                    ...
                    <div class="pm-hero__actions">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($phone): ?>
                            <a href="<?php echo e($whatsappUrl); ?>" target="_blank" class="pm-btn pm-btn--cream">WhatsApp</a>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <a href="<?php echo e(route('invoice.download', ['order' => $order])); ?>" target="_blank" class="pm-btn pm-btn--gold">
                            Download Invoice
                        </a>
                    </div>
                </div>
                ...
                <div class="inv-office">
                    <div style="min-width: 0; flex: 1 1 auto;">
                        ...
                        <address>
                            ...
                            <?php echo e($companyAddress ?: 'Alamat belum diatur'); ?>

                            · Phone: <?php echo e($companyPhone ?: '-'); ?>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($companyEmail)): ?>
                                <br>Email: <?php echo e($companyEmail); ?>

                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($companyWebsite)): ?>
                                <br>Website: <?php echo e($companyWebsite); ?>
                    ...
                    <div class="inv-office__logo" style="flex: 0 0 auto;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logoSrc): ?>
                            <img src="<?php echo e($logoSrc); ?>" alt="Logo <?php echo e($companyName); ?>">
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
            ...
            <div>
                ...
                <table class="w-full text-gray-600">
                    <tr>
                        ...
                        <td class="align-top pm-ink"><?php echo e($order->prospect->name_event ?? 'N/A'); ?></td>
                    </tr>
                    <tr>
                        <td class="align-top whitespace-nowrap pr-2 pm-muted">Nama</td>
                        <td class="align-top px-2 pm-muted">:</td>
                        <td class="align-top pm-ink">CPP_<?php echo e($order->prospect->name_cpp); ?> & CPW_<?php echo e($order->prospect->name_cpw); ?></td>
                    </tr>
                    <tr>
                        <td class="align-top whitespace-nowrap pr-2 pm-muted">Alamat</td>
                        <td class="align-top px-2 pm-muted">:</td>
                        <td class="align-top pm-ink"><?php echo e(ucwords(strtolower($order->prospect->address ?? 'N/A'))); ?></td>
                    </tr>
                    <tr>
                        <td class="align-top whitespace-nowrap pr-2 pm-muted">No Tlp</td>
                        <td class="align-top px-2 pm-muted">:</td>
                        <td class="align-top pm-ink">+62<?php echo e($order->prospect->phone ?? 'N/A'); ?></td>
                    </tr>
                    <tr>
                        <td class="align-top whitespace-nowrap pr-2 pm-muted">Venue</td>
                        <td class="align-top px-2 pm-muted">:</td>
                        <td class="align-top pm-ink"><?php echo e($order->prospect->venue ?? 'N/A'); ?> / <?php echo e($order->pax ?? 'N/A'); ?> Pax</td>
                    </tr>
                    <tr>
                        <td class="align-top whitespace-nowrap pr-2 pm-muted">Account Manager</td>
                        <td class="align-top px-2 pm-muted">:</td>
                        <td class="align-top pm-ink"><?php echo e($order->user->name ?? 'N/A'); ?></td>
                    </tr>
                    <tr>
                        <td class="align-top whitespace-nowrap pr-2 pm-muted">Event Manager</td>
                        <td class="align-top px-2 pm-muted">:</td>
                        <td class="align-top pm-ink"><?php echo e($order->employee->name ?? 'N/A'); ?></td>
                    </tr>
                </table>
            </div>
            <div>
                ...
                <table class="w-full text-gray-600">
                    <tr>
                        ...
                        <td class="align-top px-2 pm-muted">:</td>
                        <td class="align-top pm-ink"><?php echo e(now()->format('d F Y')); ?></td>
                    </tr>
                    <tr>
                        <td class="align-top whitespace-nowrap pr-2 pm-muted">Due Date</td>
                        <td class="align-top px-2 pm-muted">:</td>
                        <td class="align-top pm-ink"><?php echo e(now()->addDays(30)->format('d F Y')); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="align-top px-2 pm-muted">:</td>
                        <td class="align-top pm-ink"><?php echo e($order->prospect->date_lamaran ? \Carbon\Carbon::parse($order->prospect->date_lamaran)->format('d F Y') : '-'); ?></td>
                    </tr>
                    <tr>
                        <td class="align-top whitespace-nowrap pr-2 pm-muted">Tgl Akad</td>
                        <td class="align-top px-2 pm-muted">:</td>
                        <td class="align-top pm-ink"><?php echo e($order->prospect->date_akad ? \Carbon\Carbon::parse($order->prospect->date_akad)->format('d F Y') : '-'); ?></td>
                    </tr>
                    <tr>
                        <td class="align-top whitespace-nowrap pr-2 pm-muted">Tgl Resepsi</td>
                        <td class="align-top px-2 pm-muted">:</td>
                        <td class="align-top pm-ink"><?php echo e($order->prospect->date_resepsi ? \Carbon\Carbon::parse($order->prospect->date_resepsi)->format('d F Y') : '-'); ?></td>
                    </tr>
                </table>
            </div>
        </div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td
                                ...
                                Rp
                                <?php echo e(number_format($basePackagePrice, 0, ',', '.')); ?>
                        ...
                        <tr>
                            ...
                            <td
                                class="text-right px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                Rp
                                <?php echo e(number_format($totalVendorPrice, 0, ',', '.')); ?>

                            </td>
                        </tr>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalAdditionAmount > 0): ?>
                            <tr>
                                <td
                                    class="px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                ...
                                <td
                                    ...
                                    + Rp
                                    <?php echo e(number_format($totalAdditionAmount, 0, ',', '.')); ?>

                                </td>
                            </tr>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalAdditionVendorAmount > 0): ?>
                            <tr>
                                <td
                                    class="px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                ...
                                <td
                                    class="text-right px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-green-600">
                                    + Rp
                                    <?php echo e(number_format($totalAdditionVendorAmount, 0, ',', '.')); ?>

                                </td>
                            </tr>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalDiscountAmount > 0): ?>
                            <tr>
                                <td
                                    class="px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                ...
                                <td
                                    ...
                                    - Rp
                                    <?php echo e(number_format($totalDiscountAmount, 0, ',', '.')); ?>
                        ...
                        <tr>
                            ...
                            <td
                                ...
                                Rp
                                <?php echo e(number_format($finalPriceAfterDiscounts, 0, ',', '.')); ?>
                        ...
                        <tr>
                            ...
                            <td
                                class="text-right font-semibold px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                Rp
                                <?php echo e(number_format($finalVendorPriceAfterDiscounts, 0, ',', '.')); ?>
                        ...
                        <tr>
                            ...
                            <td
                                class="text-right font-semibold px-4 py-2 border-b border-gray-200 dark:border-gray-600 <?php echo e($calculatedProfitLoss < 25000000 ? 'text-red-600' : 'text-green-600'); ?>">
                                <strong>Rp <?php echo e(number_format($calculatedProfitLoss, 0, ',', '.')); ?></strong>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="overflow-x-auto">
                <table class="item-pengurangan-table w-full text-sm sm:text-base">
                    ...
                    <tbody>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->promo > 0): ?>
                            <tr>
                                <td
                                    class="px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                    Diskon</td>
                                <td
                                    class="text-right px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                    - Rp
                                    <?php echo e(number_format($order->promo, 0, ',', '.')); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->pengurangan > 0): ?>
                            <tr>
                                <td
                                    class="px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                    Pengurangan</td>
                                <td
                                    class="text-right px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                    - Rp
                                    <?php echo e(number_format($order->pengurangan, 0, ',', '.')); ?>
                        ...
                        <tr>
                            ...
                            <td
                                class="text-right px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                Rp
                                <?php echo e(number_format($order->bayar, 0, ',', '.')); ?>
                        ...
                        <tr>
                            ...
                            <td
                                class="text-right px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                Rp
                                <?php echo e(number_format($totalVendor, 0, ',', '.')); ?>
                        ...
                        <tr class="total">
                            ...
                            <td
                                class="text-right font-semibold px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                <strong>Rp
                                    <?php echo e(number_format($order->sisa, 0, ',', '.')); ?></strong>
                            </td>
                        </tr>
                    </tbody>
                </table>

                <?php $profitLoss = $order->laba_kotor ?? 0; ?>
                <div class="profit-loss-card <?php echo e($profitLoss >= 0 ? 'is-profit' : 'is-loss'); ?>">
                    <div class="profit-loss-card-content">
                        <div class="profit-loss-card-details">
                            ...
                            <p class="profit-loss-card-description">Selisih dengan Calculated Profit & Loss:
                                <span
                                    class="<?php echo e($selisihProfitLoss >= 0 ? 'text-green-600' : 'text-red-600'); ?> font-semibold">
                                    <?php echo e($selisihProfitLoss >= 0 ? '+' : ''); ?>Rp
                                    <?php echo e(number_format($selisihProfitLoss, 0, ',', '.')); ?>

                                </span>
                            </p>
                        </div>
                        <p class="profit-loss-card-amount">
                            Rp <?php echo e(number_format($profitLoss, 0, ',', '.')); ?>
        ...
        <div class="mt-8 pt-10 mb-10">
            ...
            <div class="overflow-x-auto">
                <table class="item-pengurangan-table w-full text-sm sm:text-base">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $allProductPengurangans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $itemPengurangan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr>
                                <td
                                ...
                                <td
                                    class="px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                    <div>
                                        <?php echo e(ucwords(strtolower($itemPengurangan->description ?? 'N/A'))); ?>

                                    </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($itemPengurangan->notes): ?>
                                        <div class="ml-7 text-gray-600 dark:text-white">
                                            <?php echo strip_tags($itemPengurangan->notes, '<li><strong><em><ul><br><span><div>'); ?>
                                ...
                                <td
                                    class="text-right px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                    Rp
                                    <?php echo e(number_format($itemPengurangan->amount ?? 0, 0, ',', '.')); ?>
        ...
        <div class="progress-bar-container">
            <div class="progress-bar-header">
                ...
                <span class="progress-bar-percentage"><?php echo e(number_format($paymentProgress, 1)); ?>%</span>
            </div>
            <div class="progress-bar-track">
                <div class="progress-bar-fill" style="width: <?php echo e($paymentProgress); ?>%"></div>
            </div>
        </div>
        ...
        <div class="mt-8">
            ...
            <div class="overflow-x-auto">
                <table class="payment-history-table w-full text-sm sm:text-base">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $order->dataPembayaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr>
                                <td
                                    class="px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                    <?php echo e(\Carbon\Carbon::parse($payment->tgl_bayar)->format('d F Y')); ?>

                                </td>
                                <td
                                    class="text-right px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                    Rp
                                    <?php echo e(number_format($payment->nominal, 0, ',', '.')); ?>

                                </td>
                                <td
                                    class="px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($payment->paymentMethod): ?>
                                        <div>
                                            <span
                                                class="font-medium text-gray-900 dark:text-white"><?php echo e($payment->paymentMethod->name); ?></span>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($payment->paymentMethod->no_rekening): ?>
                                                <br>
                                                <span
                                                    class="text-sm text-gray-600 dark:text-white"><?php echo e($payment->paymentMethod->no_rekening); ?></span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                    <?php else: ?>
                                        N/A
                                ...
                                <td
                                    class="px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                    <?php echo e($payment->keterangan); ?></td>
                            </tr>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            <tr>
                                <td colspan="4"
        ...
        <div class="mt-8">
            ...
            <div class="overflow-x-auto">
                <table class="vendor-payment-table w-full text-sm sm:text-base">
                    ...
                    <tbody>
                        <?php $visibleLimit = 5; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $allExpenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr class="vendor-expense-row <?php if($loop->iteration > $visibleLimit): ?> hidden <?php endif; ?>">
                                <td
                                    class="px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                    <?php echo e($expense->date_expense ? \Carbon\Carbon::parse($expense->date_expense)->format('d M Y') : '-'); ?>

                                </td>
                                <td
                                    class="px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                    <?php echo e($expense->vendor->name ?? 'N/A'); ?>

                                </td>
                                <td
                                    class="px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                    <?php echo e(ucwords(strtolower($expense->note ?? 'N/A'))); ?>

                                </td>
                                <td
                                    class="px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                    <?php echo e($expense->no_nd ? '' . $expense->no_nd : '-'); ?>

                                </td>
                                <td
                                    class="text-right px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                    Rp
                                    <?php echo e(number_format($expense->amount ?? 0, 0, ',', '.')); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($allExpenses->count() > $visibleLimit): ?>
                <div class="flex justify-center">
                    <button id="toggle-vendor-expenses" class="show-more-button">
                        Tampilkan <?php echo e($allExpenses->count() - $visibleLimit); ?> Lainnya
                    </button>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const visibleLimit = <?php echo e($visibleLimit); ?>;
...
<?php endif; ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/application/wofins/resources/views/filament/resources/order-resource/pages/invoice.blade.php ENDPATH**/ ?>