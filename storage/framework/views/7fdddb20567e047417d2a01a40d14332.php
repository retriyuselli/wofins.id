<?php $__env->startSection('title', 'Dokumentasi — WOFINS'); ?>
    ...
    <div class="wf-page">
        ...
        <section class="py-12 pb-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($visible->isEmpty()): ?>
                    <div class="rounded-2xl border border-[var(--wf-line)] bg-[var(--wf-cream)] px-6 py-12 text-center">
                        ...
                        <a href="<?php echo e(route('kontak')); ?>" class="wf-btn-navy inline-flex mt-6 px-5 py-3 text-sm">Hubungi Kami</a>
                    </div>
                <?php else: ?>
                    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $visible; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <?php $first = $category->documentations->first(); ?>
                            <a href="<?php echo e(route('docs.show', $first->slug)); ?>" class="wf-doc-card group">
                                ...
                                <div class="relative z-10">
                                    ...
                                    <p class="mt-2 text-sm text-[var(--wf-muted)] leading-relaxed">
                                        <?php echo e($category->documentations->count()); ?> artikel · Pelajari panduan <?php echo e(strtolower($category->name)); ?>.
                                    </p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/application/wofins/resources/views/front/documentation/index.blade.php ENDPATH**/ ?>