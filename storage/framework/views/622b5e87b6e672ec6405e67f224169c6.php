<?php $__env->startSection('title', 'Pembayaran — Paket '.$plan['name'].' · WOFINS'); ?>
    ...
    <section class="pt-10 pb-16 bg-gradient-to-b from-white to-[var(--wf-cream)]">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-8">
                ...
                <a href="<?php echo e(route('keranjang', ['paket' => $plan['key'], 'billing' => $billing])); ?>"
                ...
                <div class="lg:col-span-7">
                    <div class="wf-cart-card">
                        ...
                        <div class="wf-bank-box mb-5">
                            ...
                            <p class="text-sm font-bold text-[var(--wf-navy)]"><?php echo e($bank['bank_name'] ?? 'Bank'); ?></p>
                            <p class="text-sm text-[var(--wf-ink)] mt-1">
                                a.n. <strong><?php echo e($bank['account_name'] ?? '-'); ?></strong><br>
                                No. rek. <strong class="tracking-wide"><?php echo e($bank['account_number'] ?? '-'); ?></strong>
                            </p>
                            <p class="text-xs text-[var(--wf-muted)] mt-2">
                                Transfer tepat: <strong class="text-[var(--wf-navy)]"><?php echo e($fmt($payable)); ?></strong>
                                (termasuk kode unik <?php echo e($fmt($unique)); ?>)
                                · <?php echo e($bank['notes'] ?? ''); ?>

                            </p>
                        </div>

                        <form action="<?php echo e(route('keranjang.checkout')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="paket" value="<?php echo e($plan['key']); ?>">
                            <input type="hidden" name="billing" value="<?php echo e($billing); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div>
                                ...
                                <textarea name="notes" rows="2" class="wf-field"
                                          placeholder="Opsional — mis. jadwal aktivasi"><?php echo e(old('notes')); ?></textarea>
                            </div>
                    ...
                    <div class="wf-cart-summary">
                        ...
                        <div class="space-y-3 text-sm">
                            <div class="flex justify-between gap-3">
                                ...
                                <span class="font-semibold text-[var(--wf-navy)]"><?php echo e($fmt($amount)); ?></span>
                            </div>
                            <div class="flex justify-between gap-3">
                                <span class="text-[var(--wf-muted)]">Durasi</span>
                                <span class="font-semibold text-[var(--wf-navy)]"><?php echo e($periodLabel); ?></span>
                            </div>
                            <div class="flex justify-between gap-3">
                            ...
                            <div class="flex justify-between gap-3">
                                ...
                                <span class="font-semibold text-[var(--wf-navy)]"><?php echo e($fmt($unique)); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="border-t border-[var(--wf-line)] mt-4 pt-4">
                            <div class="flex justify-between items-end gap-3">
                                ...
                                <span class="text-2xl font-bold text-[var(--wf-navy)]"><?php echo e($fmt($payable)); ?></span>
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/application/wofins/resources/views/front/keranjang-bayar.blade.php ENDPATH**/ ?>