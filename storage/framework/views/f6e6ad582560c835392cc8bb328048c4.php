<?php $__env->startSection('title', 'Email Terverifikasi — WOFINS'); ?>
        ...
        <div class="bg-white border border-[var(--wf-line)] rounded-[1.25rem] overflow-hidden shadow-[0_18px_40px_-28px_rgba(11,31,58,0.28)]">
            ...
            <div class="p-6 sm:p-8 space-y-6">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <a href="<?php echo e(wofins_route('front.login')); ?>" class="wf-btn-gold flex-1 inline-flex items-center justify-center px-5 py-3 text-sm">
                        Silakan login
                    </a>
                    <a href="<?php echo e(wofins_route('home')); ?>" class="wf-btn-ghost flex-1 inline-flex items-center justify-center px-5 py-3 text-sm">
                        Kembali ke beranda
                    </a>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/application/wofins/resources/views/front/auth/email-verified.blade.php ENDPATH**/ ?>