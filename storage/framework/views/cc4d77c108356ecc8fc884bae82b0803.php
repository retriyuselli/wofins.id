<?php $__env->startSection('title', 'Harga Paket — WOFINS'); ?>
    ...
    <div class="wf-page" x-data="{
        ...
        <section class="pt-14 pb-10 bg-gradient-to-b from-white to-[var(--wf-cream)]">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div class="mt-8 flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-sm font-semibold text-[var(--wf-navy)]">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['Tanpa biaya instalasi', 'Update & support gratis', 'Aman & terpercaya']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $benefit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        ...
        <section class="pb-14 pt-2">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendingOrder): ?>
                    <div class="max-w-5xl mx-auto mb-6 rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-amber-800/90">
                                Kode <strong><?php echo e($pendingOrder->order_code); ?></strong> (<?php echo e($pendingOrder->plan_name); ?> · <?php echo e($pendingOrder->billing_label); ?>)
                                masih diproses. Selesaikan dulu — disetujui atau ditolak — sebelum memesan paket lain.
                            </p>
                        </div>
                        <a href="<?php echo e(route('pesanan-saya.show', $pendingOrder->order_code)); ?>"
            ...
            <div class="w-full max-w-[92rem] mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid sm:grid-cols-2 xl:grid-cols-4 gap-5 pt-1">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="wf-price-card <?php echo e($plan['popular'] ? 'is-popular' : ''); ?>">
                            ...
                            <div class="mb-5 <?php echo e($plan['popular'] ? 'pt-2' : ''); ?>">
                                <h3 class="text-xl font-bold text-[var(--wf-navy)]"><?php echo e($plan['name']); ?></h3>
                                <p class="mt-1 text-sm text-[var(--wf-muted)]"><?php echo e($plan['desc']); ?></p>
                            </div>

                            <div class="mb-5">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($plan['has_price'] && ($plan['min_billing'] ?? '') === 'biennial'): ?>
                                    <div class="flex flex-wrap items-end gap-1 min-w-0" x-show="billing !== 'quadrennial'" x-cloak>
                                        ...
                                        <span class="text-4xl font-extrabold text-[var(--wf-navy)] leading-none break-all"><?php echo e($plan['biennial_monthly_display']); ?></span>
                                    ...
                                    <div class="mt-2 text-xs text-[var(--wf-muted)] break-words" x-show="billing !== 'quadrennial'" x-cloak>
                                        Dibayar 24 bulan Rp <?php echo e($plan['biennial_total_display']); ?>

                                    </div>

                                    <div class="flex flex-wrap items-end gap-1 min-w-0" x-show="billing === 'quadrennial'" x-cloak>
                                        <span class="text-sm font-semibold text-[var(--wf-muted)] mb-1">Rp</span>
                                        <span class="text-4xl font-extrabold text-[var(--wf-navy)] leading-none break-all"><?php echo e($plan['quadrennial_monthly_display']); ?></span>
                                        <span class="text-sm text-[var(--wf-muted)] mb-1">/ bulan</span>
                                    </div>
                                    <div class="mt-2 text-xs text-[var(--wf-muted)] break-words" x-show="billing === 'quadrennial'" x-cloak>
                                        Dibayar 48 bulan Rp <?php echo e($plan['quadrennial_total_display']); ?>
                                ...
                                <?php elseif($plan['has_price']): ?>
                                    
                                    <div class="flex flex-wrap items-end gap-1 min-w-0" x-show="billing === 'monthly'" x-cloak>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($plan['price_prefix'])): ?>
                                            <span class="text-sm font-semibold text-[var(--wf-muted)] mb-1 w-full sm:w-auto"><?php echo e($plan['price_prefix']); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <span class="text-sm font-semibold text-[var(--wf-muted)] mb-1">Rp</span>
                                        <span class="text-4xl font-extrabold text-[var(--wf-navy)] leading-none break-all"><?php echo e($plan['monthly_display']); ?></span>
                                        <span class="text-sm text-[var(--wf-muted)] mb-1">/ bulan</span>
                                    </div>
                                    ...
                                    <div class="flex flex-wrap items-end gap-1 min-w-0" x-show="billing === 'annual'" x-cloak>
                                        ...
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <span class="text-sm font-semibold text-[var(--wf-muted)] mb-1">Rp</span>
                                        <span class="text-4xl font-extrabold text-[var(--wf-navy)] leading-none break-all"><?php echo e($plan['annual_monthly_display']); ?></span>
                                        <span class="text-sm text-[var(--wf-muted)] mb-1">/ bulan</span>
                                    </div>
                                    <div class="mt-2 text-xs text-[var(--wf-muted)] break-words" x-show="billing === 'annual'" x-cloak>
                                        Dibayar 12 bulan Rp <?php echo e($plan['annual_total_display']); ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($plan['pricing_note'])): ?>
                                        <div class="mt-1 text-xs text-[var(--wf-muted)] break-words"><?php echo e($plan['pricing_note']); ?></div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php else: ?>
                            ...
                            <ul class="space-y-2.5 mb-8 flex-1">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = \App\Support\PricingPlans::featureItems($plan); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <li class="flex items-start gap-2.5 text-sm text-[var(--wf-ink)]">
                                        <span class="wf-check <?php echo e($plan['check']); ?>"><i class="fa-solid fa-check"></i></span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($feature['tip']): ?>
                                            <span class="wf-feature-tip"
                                                  tabindex="0"
                                                  role="button"
                                                  aria-label="<?php echo e($feature['label']); ?>: <?php echo e($feature['tip']); ?>"
                                                  @click.prevent="openTip = openTip === '<?php echo e($plan['key']); ?>-<?php echo e($loop->index); ?>' ? null : '<?php echo e($plan['key']); ?>-<?php echo e($loop->index); ?>'"
                                                  @keydown.escape.window="openTip = null"
                                                  :class="{ 'is-open': openTip === '<?php echo e($plan['key']); ?>-<?php echo e($loop->index); ?>' }">
                                                <?php echo e($feature['label']); ?>

                                                <span class="wf-feature-tip__bubble" role="tooltip"><?php echo e($feature['tip']); ?></span>
                                            </span>
                                        <?php else: ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendingOrder && ($plan['selectable'] ?? true)): ?>
                                <span class="<?php echo e($plan['cta_class']); ?> w-full inline-flex items-center justify-center px-4 py-3 text-sm text-center opacity-50 cursor-not-allowed pointer-events-none"
                                      aria-disabled="true"
                                      title="Selesaikan pesanan <?php echo e($pendingOrder->order_code); ?> terlebih dahulu">
                                    Menunggu tinjauan pesanan
                                </span>
                            <?php elseif(! empty($plan['cta_url']) || ! ($plan['selectable'] ?? true)): ?>
                                <a href="<?php echo e($plan['cta_url'] ?? 'https://wa.me/6281373183794?text='.rawurlencode('Halo, saya ingin konsultasi paket Enterprise WOFINS.')); ?>"
                                   target="_blank"
                                   rel="noopener noreferrer"
                                   class="<?php echo e($plan['cta_class']); ?> w-full inline-flex items-center justify-center px-4 py-3 text-sm text-center">
                                    <?php echo e($plan['cta']); ?>

                                </a>
                            <?php else: ?>
                                <a :href="'<?php echo e(route('keranjang')); ?>?paket=<?php echo e($plan['key']); ?>&billing=' + billing"
                                   class="<?php echo e($plan['cta_class']); ?> w-full inline-flex items-center justify-center px-4 py-3 text-sm text-center">
                                    <?php echo e($plan['cta']); ?>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="wf-table-wrap">
                    <table class="wf-compare w-full text-sm">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $compareRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <tr>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $cell): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <td>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($i === 0): ?>
                                                <?php echo e($cell); ?>

                                            <?php elseif($cell === true): ?>
                                                <i class="fa-solid fa-check text-emerald-500"></i>
                                            <?php elseif($cell === false): ?>
                                                <span class="text-[var(--wf-muted)]">—</span>
                                            <?php else: ?>
                                                <span class="<?php echo e($i === 2 ? 'font-semibold text-[#9a7a12]' : 'text-[var(--wf-muted)]'); ?>"><?php echo e($cell); ?></span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </td>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                </tr>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 gap-8 items-start">
                    <div>
                                ...
                                <div class="wf-faq-item">
                                    <button type="button"
                                        ...
                                        <i class="fa-solid fa-chevron-down text-xs text-[var(--wf-muted)] transition-transform"
                                           :class="openFaq === <?php echo e($i); ?> && 'rotate-180'"></i>
                                    </button>
                                    <div x-show="openFaq === <?php echo e($i); ?>" x-cloak class="px-5 pb-4 text-sm text-[var(--wf-muted)] leading-relaxed">
                                        <?php echo e($faq[1]); ?>
                        ...
                        <a href="<?php echo e(route('home')); ?>#faq" class="inline-flex items-center gap-2 mt-5 text-sm font-bold text-[var(--wf-gold)] hover:brightness-90">
                    ...
                    <div class="wf-cta-box p-8 sm:p-10 min-h-[22rem]">
                        ...
                        <div class="relative z-10 max-w-md">
                            ...
                            <div class="mt-7 flex flex-col sm:flex-row gap-3">
                                <a href="<?php echo e(route('kontak')); ?>" class="wf-btn-gold inline-flex items-center justify-center px-5 py-3 text-sm">
                                    Jadwalkan Demo Gratis
                                </a>
                                <a href="<?php echo e(route('kontak')); ?>" class="wf-btn-outline-light inline-flex items-center justify-center px-5 py-3 text-sm">
                                    Konsultasi Sekarang
                                </a>
                            </div>
                        </div>
        ...
        <a href="https://wa.me/6281373183794?text=<?php echo e(urlencode('Halo, saya ingin tanya paket harga WOFINS.')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/application/wofins/resources/views/front/harga.blade.php ENDPATH**/ ?>