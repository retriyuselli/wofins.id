                ...
                <div class="grid sm:grid-cols-2 xl:grid-cols-4 gap-5 pt-1">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="wf-price-card <?php echo e($plan['popular'] ? 'is-popular' : ''); ?>">
                            ...
                            <div class="mb-5">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($plan['has_price']): ?>
                                    ...
                                    <div class="flex items-end gap-1" x-show="billing === 'monthly'" x-cloak>
                                        ...
                                        <span class="text-4xl font-extrabold text-[var(--wf-navy)] leading-none"><?php echo e($plan['monthly_display']); ?></span>
                                    ...
                                    <div class="flex items-end gap-1" x-show="billing === 'annual'" x-cloak>
                                        <span class="text-sm font-semibold text-[var(--wf-muted)] mb-1">Rp</span>
                                        <span class="text-4xl font-extrabold text-[var(--wf-navy)] leading-none"><?php echo e($plan['annual_monthly_display']); ?></span>
                                        <span class="text-sm text-[var(--wf-muted)] mb-1">/ bulan</span>
                                    </div>
                                    ...
                                    <div class="flex items-end gap-1" x-show="billing === 'biennial'" x-cloak>
                                        <span class="text-sm font-semibold text-[var(--wf-muted)] mb-1">Rp</span>
                                        <span class="text-4xl font-extrabold text-[var(--wf-navy)] leading-none"><?php echo e($plan['biennial_monthly_display']); ?></span>
                                        <span class="text-sm text-[var(--wf-muted)] mb-1">/ bulan</span>
                                    </div>
                                    ...
                                    <div class="flex items-end gap-1" x-show="billing === 'quadrennial'" x-cloak>
                                        <span class="text-sm font-semibold text-[var(--wf-muted)] mb-1">Rp</span>
                                        <span class="text-4xl font-extrabold text-[var(--wf-navy)] leading-none"><?php echo e($plan['quadrennial_monthly_display']); ?></span>
                                        <span class="text-sm text-[var(--wf-muted)] mb-1">/ bulan</span>
                                    </div>
                            ...
                            <?php elseif(! empty($plan['cta_url']) || ! ($plan['selectable'] ?? true)): ?>
                                <a href="<?php echo e($plan['cta_url'] ?? 'https://wa.me/6281373183794?text='.rawurlencode('Halo, saya ingin konsultasi paket Custom WOFINS.')); ?>"
                                   target="_blank"
