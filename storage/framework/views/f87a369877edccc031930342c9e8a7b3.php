...
<head>
    ...
    <title>Product Details - <?php echo e($product->name); ?></title>
    ...
    <div
        ...
        <div class="text-center mb-6 pb-4 border-b border-gray-200">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logoSrc): ?>
                <img src="<?php echo e($logoSrc); ?>" alt="<?php echo e($company?->company_name ?? ($companyName ?? config('app.name'))); ?>"
                    class="max-h-10 mx-auto mb-4">
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            
            <p class="text-[12px] text-gray-600 mt-1.5">
                <?php echo e($companyAddress ?? $company?->address ?? 'Alamat belum diatur'); ?>

            </p>
            <p class="text-[12px] text-gray-600 mt-0"><?php echo e($companyName ?? $company?->company_name ?? config('app.name')); ?> |
                <?php echo e($companyEmail ?? $company?->email ?? '-'); ?> | <?php echo e($companyPhone ?? $company?->phone ?? '-'); ?></p>
        </div>
        ...
        <table class="w-full mt-4 border-collapse text-sm">
            <tr>
                <td class="border border-gray-300 p-3 w-1/2 align-top text-[13px]">
                    ...
                    Product Name : <?php echo e($product->name ?? 'N/A'); ?><br>
                    Category : <?php echo e($product->category->name ?? 'N/A'); ?><br>
                    Capacity : <?php echo e($product->pax ?? 'N/A'); ?> Pax
                </td>
                <td class="border border-gray-300 p-3 w-1/2 align-top text-[13px]">
                    <strong>Document Details</strong><br>
                    Reference : PROD-<?php echo e(str_pad($product->id ?? 0, 6, '0', STR_PAD_LEFT)); ?><br>
                    Date : <?php echo e(now()->format('d F Y H:i:s')); ?><br>
                    Printed By : <strong><?php echo e(auth()->user()->name); ?></strong>
                </td>
            </tr>
        </table>
        ...
        <div class="mt-8 border border-slate-200 p-4 sm:p-5 rounded-lg bg-white shadow-sm">
            ...
            <table class="w-full border-collapse text-sm">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $product->items ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr
                            class="odd:bg-white even:bg-slate-50/70 hover:bg-indigo-50/70 transition-colors duration-150 ease-in-out">
                            <td class="col-no border border-slate-300 py-3 align-top"><?php echo e($loop->iteration); ?>

                            </td>
                            <td class="border border-slate-300 px-4 py-3 align-top">
                                <div class="font-bold uppercase text-[13px]">
                                    <?php echo e($item->vendor->name ?? 'Vendor Tidak Diketahui'); ?></div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->description): ?>
                                    <div class="details-notes text-sm text-black ml-4"><?php echo \App\Support\ProductNotesFormatter::forPreview($item->description); ?></div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            <td class="border border-slate-300 px-4 text-[13px] py-3 text-right align-top">
                                ...
                                ?>
                                <?php echo e(number_format($vendorLine, 0, ',', '.')); ?>

                            </td>
                            <td class="border border-slate-300 px-4 py-3 text-[13px] text-right align-top">
                                <?php echo e(number_format($publicLine, 0, ',', '.')); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($product->penambahanHarga ?? collect())->count() > 0): ?>
            <div class="mt-8 border border-slate-200 p-4 sm:p-5 rounded-lg bg-white shadow-sm">
                ...
                <table class="w-full border-collapse text-sm">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $product->penambahanHarga; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $addition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr
                                class="odd:bg-white even:bg-slate-50/70 hover:bg-indigo-50/70 transition-colors duration-150 ease-in-out">
                                ...
                                <td class="border border-slate-300 px-4 py-3 align-top">
                                    <div class="font-bold uppercase text-[13px]">
                                        <?php echo e($addition->vendor->name ?? 'Item Tidak Diketahui'); ?></div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($addition->description): ?>
                                        <?php
                                        ...
                                        ?>
                                        <div class="details-notes text-sm text-black ml-4"><?php echo $detailsNotes; ?></div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td class="border border-slate-300 px-4 py-3 text-right align-top text-[13px]"
                                    style="width: 15%">
                                    <?php echo e(number_format($addition->harga_vendor ?? 0, 0, ',', '.')); ?>

                                </td>
                                <td class="border border-slate-300 px-4 py-3 text-right align-top text-[13px]"
                                    style="width: 15%">
                                    <?php echo e(number_format($addition->harga_publish ?? 0, 0, ',', '.')); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($product->pengurangans ?? collect())->count() > 0): ?>
            <div class="mt-8 border border-slate-200 p-4 sm:p-5 rounded-lg bg-white shadow-sm">
                ...
                <table class="w-full border-collapse text-sm">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $product->pengurangans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $discount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr
                                class="odd:bg-white even:bg-slate-50/70 hover:bg-indigo-50/70 transition-colors duration-150 ease-in-out">
                                <td class="col-no border border-slate-300 py-3 align-top text-[13px]">
                                    <?php echo e($index + 1); ?>
                                ...
                                <td class="border border-slate-300 px-4 py-3 align-top">
                                    <div class="font-bold uppercase text-[13px]">
                                        <?php echo e($discount->description ?? 'Vendor Tidak Diketahui'); ?></div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($discount->notes): ?>
                                        <?php
                                ...
                                <td class="border border-slate-300 px-4 py-3 text-right align-top text-[13px]"
                                    style="width: 18%">
                                    <?php echo e(number_format($discount->amount ?? 0, 0, ',', '.')); ?>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border border-gray-300 p-2 text-right">
                            <?php echo e(number_format($totalPublicPrice, 0, ',', '.')); ?></td>
                        <td class="border border-gray-300 p-2 text-right">
                            <?php echo e(number_format($totalVendorPrice, 0, ',', '.')); ?></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="border border-gray-300 p-2 text-right text-green-600">+
                            <?php echo e(number_format($totalAdditionAmount, 0, ',', '.')); ?></td>
                        <td class="border border-gray-300 p-2 text-right text-green-600">+
                            <?php echo e(number_format($totalAdditionVendorAmount, 0, ',', '.')); ?></td>
                    </tr>
                    ...
                    <tr class="bg-gray-50">
                        ...
                        <td class="border border-gray-300 p-2 text-right font-bold">
                            <?php echo e(number_format($subtotalPublish, 0, ',', '.')); ?></td>
                        <td class="border border-gray-300 p-2 text-right font-bold">
                            <?php echo e(number_format($subtotalVendor, 0, ',', '.')); ?></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="border border-gray-300 p-2 text-right text-red-600">-
                            <?php echo e(number_format($totalDiscountAmount, 0, ',', '.')); ?></td>
                        <td class="border border-gray-300 p-2 text-right text-red-600">-
                            <?php echo e(number_format($totalDiscountAmount, 0, ',', '.')); ?></td>
                    </tr>
                    ...
                    <tr class="bg-gray-50">
                        ...
                        <td class="border border-gray-300 p-2 text-right font-bold">
                            <?php echo e(number_format($finalPriceAfterDiscounts, 0, ',', '.')); ?></td>
                        <td class="border border-gray-300 p-2 text-right font-bold">
                            <?php echo e(number_format($finalVendorPriceAfterDiscounts, 0, ',', '.')); ?></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td
                            class="border border-gray-300 p-2 text-right font-bold <?php echo e($profitAndLoss < 0 ? 'text-red-600' : 'text-green-600'); ?>">
                            <?php echo e(number_format($profitAndLoss, 0, ',', '.')); ?>
            ...
            <table class="w-full border-collapse text-sm">
                ...
                <tr>
                    ...
                    <td class="border border-gray-300 p-2 text-right text-xs">
                        <?php echo e(number_format($calculatedGrandTotal * 0.1, 0, ',', '.')); ?></td>
                ...
                <tr>
                    ...
                    <td class="border border-gray-300 p-2 text-right text-xs">
                        <?php echo e(number_format($calculatedGrandTotal * 0.2, 0, ',', '.')); ?></td>
                ...
                <tr>
                    ...
                    <td class="border border-gray-300 p-2 text-right text-xs">
                        <?php echo e(number_format($calculatedGrandTotal * 0.4, 0, ',', '.')); ?></td>
                ...
                <tr>
                    ...
                    <td class="border border-gray-300 p-2 text-right text-xs">
                        <?php echo e(number_format($calculatedGrandTotal * 0.3, 0, ',', '.')); ?></td>
        ...
        <div class="flex flex-col md:flex-row items-center justify-center gap-4 mt-8 mb-6 print:hidden">
            ...
            <?php if (isset($component)) { $__componentOriginala1eff43ba6163f9e21fd340194f0b558 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala1eff43ba6163f9e21fd340194f0b558 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.download-pdf-button','data' => ['route' => route('products.downloadPdf', $product),'label' => 'Download PDF','class' => 'px-4 py-2 bg-blue-600 hover:bg-blue-500 active:bg-blue-700 text-white text-xs uppercase font-semibold rounded-md transition']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('download-pdf-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['route' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('products.downloadPdf', $product)),'label' => 'Download PDF','class' => 'px-4 py-2 bg-blue-600 hover:bg-blue-500 active:bg-blue-700 text-white text-xs uppercase font-semibold rounded-md transition']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala1eff43ba6163f9e21fd340194f0b558)): ?>
<?php $attributes = $__attributesOriginala1eff43ba6163f9e21fd340194f0b558; ?>
<?php unset($__attributesOriginala1eff43ba6163f9e21fd340194f0b558); ?>
<?php endif; ?>
<?php if (isset($__componentOriginala1eff43ba6163f9e21fd340194f0b558)): ?>
<?php $component = $__componentOriginala1eff43ba6163f9e21fd340194f0b558; ?>
<?php unset($__componentOriginala1eff43ba6163f9e21fd340194f0b558); ?>
<?php endif; ?>

            
            <?php if (isset($component)) { $__componentOriginala1eff43ba6163f9e21fd340194f0b558 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala1eff43ba6163f9e21fd340194f0b558 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.download-pdf-button','data' => ['route' => route('products.exportExcelDetail', $product),'label' => 'Export to Excel','class' => 'px-4 py-2 bg-green-600 hover:bg-green-500 active:bg-green-700 text-white text-xs uppercase font-semibold rounded-md transition']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('download-pdf-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['route' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('products.exportExcelDetail', $product)),'label' => 'Export to Excel','class' => 'px-4 py-2 bg-green-600 hover:bg-green-500 active:bg-green-700 text-white text-xs uppercase font-semibold rounded-md transition']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/application/wofins/resources/views/products/details-preview.blade.php ENDPATH**/ ?>