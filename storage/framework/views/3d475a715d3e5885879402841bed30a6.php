...
<head>
    ...
    <title>Akun Diaktifkan — <?php echo e(config('app.name')); ?></title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <p class="lead">
            Halo <strong><?php echo e($user->name); ?></strong>, selamat! Akun WOFINS Anda sudah disetujui oleh admin
        ...
        <div class="box">
            ...
            <div class="summary-line">
                <span class="label">Nama</span> : <span class="value"><?php echo e($user->name); ?></span>
            </div>
            <div class="summary-line">
                <span class="label">Email</span> : <span class="value"><?php echo e($user->email); ?></span>
            </div>
            <div class="summary-line">
        ...
        <div class="box" style="text-align: center;">
            ...
            <a href="<?php echo e($dashboardUrl); ?>" class="btn">Kunjungi Dashboard</a>
            <p style="margin-top: 14px; font-size: 12px; color: #5c6675;">
                Atau buka tautan ini:<br>
                <a href="<?php echo e($dashboardUrl); ?>" style="color: #0b1f3a;"><?php echo e($dashboardUrl); ?></a>
            </p>
        </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/application/wofins/resources/views/emails/user-activated.blade.php ENDPATH**/ ?>